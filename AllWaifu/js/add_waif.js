...
function fclick() {
    var lastRow = $(this).parent().parent().parent().parent().find('.desc_field_row').eq(-1);
...
function parsePageToWaifuXml() {
    ...
    waif.tags = tags;
    waif.alterNames = $("#AlterNames")[0].value;
...
function RestorePage() {
    ...
    rofl.Chapters.forEach(function (chapter, i, chapters) {
        ...
        chapt_ex.find(".type_title").find(".field_input")[0].value = chapter.Title;
        var valie = 0;
    ...
    $("#AlterNames")[0].value = rofl.AlterNames;
